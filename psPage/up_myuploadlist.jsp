                        ...
                        <div class="col-xs-12">
                            <div class="bradcaump__inner">
                                <nav class="bradcaump-inner">
                                  <a class="breadcrumb-item" style="color: #ffffff; font-size: 30px;" >${listss.get(1).uploadUserId }'S  UPLOAD</a>
                        ...
                        <div class="col-md-6 col-lg-4 col-sm-12 col-xs-12">
                            <div class="blog">
                                <div class="blog__thumb">
                                    <a href="${imagePath}/${listss.get(i).fileName}"> 
										<img src="${imagePath}/${listss.get(i).fileName}" width="300" height="300" />
									</a>
                                </div>
                                <div class="blog__details">
                                    <div class="bl__date">
                                    	<div style="padding-left: 120px;" class="product-remove">
                                        ${listss.get(i).fileName }
