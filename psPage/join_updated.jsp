...
function sendIt() {
	...
	f.action = "<%=cp%>/picsell/join_updatedok.do";
	f.submit();
}
		...
		<div class="order-details"> 
 			<div class="footer">
				<div class="ft__inner">
					...
					<tr style="border-bottom: 0; border-bottom-color: #ffffff;">
						 <td>
					 		<h5 class="order-details__title" style="font-size: 25px;"> 회원 정보 수정하기 </h5> 
						</td>
					</tr>
					<tr style="border-bottom: 0; border-bottom-color: #ffffff;">
						<td style="padding-left: 20px; padding-top: 20px;">
							<b style="padding-left: 55px;">ID :</b> &nbsp; <input type="text"  name = "userId" onfocus="this.value=''" value="${join_dto.userId}" style="width: 300px;"height:50px;"><br /> <br />
						</td>
					</tr>
					<tr style="border-bottom: 0; border-bottom-color: #ffffff;">
						<td style="padding-left: 20px; padding-top: 20px;"> 
							<b style="padding-left: 30px;">NAME :</b> &nbsp; <input type="text" name = "userName" onfocus="this.placeholder=''" value="${join_dto.userName}" style="width: 300px;"height:50px;"> <br /> <br />
						</td>
					</tr>
					<tr style="border-bottom: 0; border-bottom-color: #ffffff;">
						<td style="padding-left: 20px; padding-top: 20px;">
							<b style="padding-left: 35px;">PWD :</b> &nbsp;&nbsp; <input type="password" name = "userPwd" onfocus="this.placeholder=''" value="${join_dto.userPwd}" style="width: 300px;"height:50px;"> <br /> <br />
						</td>
					</tr>
					<tr style="border-bottom: 0; border-bottom-color: #ffffff;">
						<td style="padding-left: 20px; padding-top: 20px;"> 
							<b style="padding-left: 20px;">E-MAIL :</b>&nbsp;&nbsp;&nbsp; <input type="text" name = "userEmail" onfocus="this.placeholder=''" value="${join_dto.userEmail }"style="width: 300px;"height:50px;"> <br /> <br />
						</td>
					</tr>
					<tr>
						<td style="padding-left: 20px; padding-top: 20px; padding-bottom: 30px;"> 
							<b style="padding-left: 45px; ">TEL :</b>&nbsp;&nbsp;&nbsp; <input type="text" name = "userTel" onfocus="this.placeholder=''" value="${join_dto.userTel }" style="width: 300px;"height:50px;">
						</td>
					</tr>	
					...
					<div class="send__btn" align="center">
						<input type="hidden" value="${join_dto.userId }" name = "userId"><br/>
						<a style="margin-left: 10px; border-radius: 10px;" class="fr__btn" onclick="sendIt();">COMPLETE</a> &nbsp;&nbsp;&nbsp;
						<a style="border-radius: 10px;" class="fr__btn" onclick="javascript:location.href='<%=cp%>/picsell/main.do';" />CANCEL</a>
